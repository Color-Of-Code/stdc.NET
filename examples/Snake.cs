/* Author: Matthew Vlietstra Version: 0.5 Date: 28/09/2010 */
// Source: MIT from https://github.com/Contagious06/console-snake-game.git
...
public class Snake : C
{
    const int SNAKE_ARRAY_SIZE = 310;
    ...
    const int EXIT_BUTTON = 13; // ESC
    const int PAUSE_BUTTON = 112; // P

    char waitForAnyKey()
    {
        while (!kbhit()) System.Threading.Thread.Sleep(50); // avoid busy wait
