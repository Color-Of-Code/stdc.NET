...
void main(){
   ...
   /*		 setcolor(bk);		 rectangle(0,0,639,479);		 setfillstyle(SOLID_FILL,bk);		 floodfill(250,250,bk);*/
		 ...
		 while (1){
		 		 ...
		 		 if(hit==1){
		 		 		 hit=0;
		 		 		 target.x=size+size*C.random(25);
		 		 		 target.y=size+size*C.random(20);
...
int check(){
		 ...
		 if(blocks==40){
		 		 stage++;
		 		 blocks=4;
		 		 C.sprintf(msg,"STAGE %d CLEARED",stage-1);
		 		 setcolor(4);
		 		 settextstyle(1,HORIZ_DIR,6);
		 		 outtextxy(150,200,msg);
		 		 delay(2000);
